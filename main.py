...
def fetch_maude_events(catalog_number, api_key=None, limit=100):
    """Fetches MAUDE adverse event reports for a specific catalog number."""
...
if __name__ == "__main__":
    ...
    if all_processed_results:
        ...
        for i, entry in enumerate(all_processed_results, 1):
            print(f"{i}. [CAT: {entry['Searched CAT']}] | Lot: {entry['Lot Number']} | Date: {entry['Date of Event']}")
